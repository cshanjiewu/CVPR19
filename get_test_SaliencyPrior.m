function [ net ] = get_test_SaliencyPrior(varargin)
addpath('src');
...
opts.net_path = 'get_train_SaliencyPrior/net-epoch-10.mat'; 
opts.save_img_path = 'test_img_sp';
...
for i = 1:opts.num_images 
    tic;
    c= clock;
    data = vl_imreadjpeg(imdb.images.data(randi(length(imdb.images.data))));
%     data = vl_imreadjpeg(imdb.images.data(10));
    input = data{1}/255*2-1; % set in the range of [-1:1]
...
fprintf('get_test_SaliencyPrior is complete\n');
